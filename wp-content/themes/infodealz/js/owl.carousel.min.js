...
jQuery(document).ready(function($) {
	...
	$('.slide-first-img').imagesLoaded(function() {
		...
		if ( jQuery('#slider').length ) {
			jQuery('#slider').each(function() {
				var homeSlider = jQuery(this),
					homeSliderContainer = homeSlider.closest('.primary-slider-container');
				...
				homeSlider.owlCarousel({
					...
					onInitialized: function(){
						homeSliderContainer.loadImages().removeClass('loading');
					}
				});
			});
		}
		...
		// Product gallery
		if ( jQuery('.product-img-slider').length ) {
			jQuery('.product-img-slider').each(function() {
				...
				productImgSlider.owlCarousel({
					...
					navText: ['<i class="fa fa-angle-left"><i>','<i class="fa fa-angle-right"><i>'],
					onInitialized: function(){
						productImgSliderContainer.loadImages().removeClass('loading');
					}
				});
			});
		}
...
jQuery( window ).load(function() {
	...
	// Home product subcat carousels
	if ( jQuery('.subcategories-carousel').length ) {
		jQuery('.subcategories-carousel').each(function() {
			...
			carousel.owlCarousel({
				...
				onInitialized:function(a){
					//if (carouselContainer.find('.owl-item').length <= 5) carousel.addClass('hidenav');
