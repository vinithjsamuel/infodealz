...
class mts_author_posts_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if(is_singular()){
			...
			echo self::get_author_posts( $qty, $comment_num, $date, $show_thumb7, $box_layout, $show_excerpt, $excerpt_length );
			echo $after_widget;
		}
	}

	public function get_author_posts( $qty, $comment_num, $date, $show_thumb7, $box_layout, $show_excerpt, $excerpt_length ) {
		...
		while ( $posts->have_posts() ) { $posts->the_post(); ?>
			<?php echo $open_li_item; ?>
				<?php if ( $show_thumb7 == 1 && has_post_thumbnail() ) : ?>
				<div class="post-img">
