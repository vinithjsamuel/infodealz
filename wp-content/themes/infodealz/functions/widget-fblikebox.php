...
class Facebook_Like_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		if($page_url): ?>
			<div class="fb-like-box" data-href="<?php echo esc_attr( $page_url ); ?>" data-height="<?php echo esc_attr( $height ); ?>" data-width="<?php echo esc_attr( $width ); ?>" data-colorscheme="<?php echo esc_attr( $color_scheme ); ?>" data-show-faces="<?php echo esc_attr( $show_faces ); ?>" data-header="<?php echo esc_attr( $show_header ); ?>" data-stream="<?php echo esc_attr( $show_stream ); ?>" allowTransparency="true" data-show-border="false"></div>
		<?php endif;
	...
	{
		$defaults = array('title' => __('Find us on Facebook','mythemeshop'), 'page_url' => '', 'width' => '324', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
