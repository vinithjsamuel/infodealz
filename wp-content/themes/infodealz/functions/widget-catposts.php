...
class single_category_posts_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo self::get_cat_posts( $cat, $qty, $comment_num, $date, $show_thumb1, $box_layout, $show_excerpt, $excerpt_length );
		echo $after_widget;
	}

	public function get_cat_posts( $cat, $qty, $comment_num, $date, $show_thumb1, $box_layout, $show_excerpt, $excerpt_length ) {
		...
		while ( $posts->have_posts() ) { $posts->the_post(); ?>
			<?php echo $open_li_item; ?>
				<?php if ( $show_thumb1 == 1  && has_post_thumbnail() ) : ?>
					<div class="post-img">
